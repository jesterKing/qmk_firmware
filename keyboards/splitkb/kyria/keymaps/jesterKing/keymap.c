 ...
 */
    [_RAISE] = LAYOUT(
      ...
      _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_LALT, _______, _______, _______, _______, _______, KC_DOWN, _______, _______, _______,
 ...
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |UC_M_WC | F1   |  F2  | F3   | F4   | F5   |                              | F6   | F7   |  F8  | F9   | F10  | F11    |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |UC_M_MA |      |      | DAS  | PLVR | QWRT |                              | MWup | MLft | MUp  | MRgt |      | F12    |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |UC_M_LN |      |      |      |      |      |      |      |  |      |      | MWdn | LMB  | MDn  | RMB  |      | QK_BOOT|
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      |      |      |      |      |  |      |      |      |      | MMB  |
 *                        `----------------------------------'  `----------------------------------'
 */
    [_ADJUST] = LAYOUT(
      UC_M_WC, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                                       KC_F6,   KC_F7,    KC_F8,   KC_F9,   KC_F10,   KC_F11,
      UC_M_MA, _______, _______, DAS  ,    PLVR,      QWRT,                                     KC_WH_U, KC_MS_L,  KC_MS_U, KC_MS_R, _______,  KC_F12,
      UC_M_LN, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_WH_D, KC_BTN1,  KC_MS_D, KC_BTN2, _______, QK_BOOT,
...
void keyboard_post_init_user(void) {
    ...
    pimoroni_trackball_set_rgbw(255, 128, 64, 0);
}
...
{
    HSV   hsv  = {get_current_wpm(), 255, 255};
